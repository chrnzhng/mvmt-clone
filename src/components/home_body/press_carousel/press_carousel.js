...
class PressCarousel extends Component {
    render() {
        ...
        return (
            <Slider {...settings}>
                <div><h3>"Literally keffiyeh man braid messenger bag<br></br>
                     you probably haven't heard of them <br></br>
                     pour-over cornhole"</h3><img className = "test" src= {require('./press-img-1.svg')} /></div>
                <div><h3>"Skateboard fixie banjo, helvetica cronut<br></br>
                ...
                <div><h3>"Hell of af copper mug pop-up neutra<br></br>
                ...
                <div><h3>"Seitan freegan pug gentrify lo-fi edison<br></br>
                ...
                <div><h3>"Taxidermy heirloom meh put a bird on it<br></br>
